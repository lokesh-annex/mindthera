...
const ServiceKollektiveErlebnisse: React.FC = () => (
  <>
    <div className="container py-5">
      <div className="d-flex flex-column flex-md-row align-items-center justify-content-center">
        <div className="mb-4 mb-md-0 me-md-4">
          <img
            src="/images/services/16.webp"
            alt="Kollektive Erlebnisse"
            style={{
             width: "320px",
    ...
    <section className="pt-10 pb-4 session-sec-bg">
    ...
    <section className="pt-2 pb-8 price-sec" style={{ position: "relative" }}>
                ...
                <ul className="fs-5 text-dark mb-0 w-100 list-unstyled">
                  <li className="mb-3 d-flex align-items-center gap-3">
                    ...
                    <span className="fw-semibold">
                      1111
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 432.763 432.762">
                        <g>
...
export default ServiceKollektiveErlebnisse;