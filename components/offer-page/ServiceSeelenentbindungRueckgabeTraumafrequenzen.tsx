...
const ServiceSeelenentbindungRueckgabeTraumafrequenzen: React.FC = () => (
  <>
   <div className="container py-5">
    <div className=" d-flex flex-column flex-md-row align-items-center justify-content-center">
        <div className="mb-4 mb-md-0 me-md-4 ">
            <img src="/images/services/15.webp" alt="Harmonyum Trauma Release" style={{
                  width: "320px",
...
export default ServiceSeelenentbindungRueckgabeTraumafrequenzen;