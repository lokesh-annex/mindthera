...
export default function AblaufDerBehandlung() {
  return (
    <section className=" py-8 bg-light">
      ...
      <p className="dark-color">Es wird empfohlen, sich mindestens 7–10 Behandlungen Harmonyum Trauma Release® geben zu lassen, da es viele Traumata gibt, die vergessen bzw. verdrängt wurden oder nicht bekannt sind.</p>
      </div>
    </section>
  );
}
