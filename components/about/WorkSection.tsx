...
const API_URL =
  "http://localhost:3001/api/pages/68bec51e2880ed52c0efdf22?depth=2&draft=false&locale=undefined&trash=false";
      ...
      <div className="container">
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-lg-5 mb-4 mb-lg-0 d-flex justify-content-center">
            ...
            >
              <Image
                src={`http://localhost:3001/${content.image1?.url || "/images/image-16.jpg"}`}
